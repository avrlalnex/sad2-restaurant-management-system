<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if($_POST['submit'] == "view"){
      ...
      header("Location: purchase_order_view_archive.php");
      exit();
...
<section class="home-section">
  <div class="text">Delivered Purchase Orders</div>

  <div class="header-container">
    <a href="purchase_orders_page.php"><button class="add-button">Return</button></a>
  ...
  <div class="inventory-table">
    <table class="item-table">
      ...
      <tbody>
        <?php $inv_tbl->show_purchase_orders_archive($_SESSION['purchase_order_search'],$_SESSION['purchase_order_filter_date']);?>       
      </tbody>
    </table>
