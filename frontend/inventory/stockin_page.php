<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if ($_POST['submit']=="Submit"){
      $result = $inv_tbl->add_stockin($_POST['stock-id'],$_POST['stock-quant'],$_POST['stock-price'],$_POST['stock-date'],$_POST['stock-desc']);
...
<div class="add-item-container">
  ...
  <form method="POST">
    ...
    <div class="input-container">
      <label for="stock-quant">Stock IN Quantity:</label>
    ...
    <div class="input-container">
      ...
      <input type="text" id="input_value" oninput="check_num(this.value,this.id)" name="stock-price">
    </div>
    <div class="input-container">
