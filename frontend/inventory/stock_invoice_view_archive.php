...
<section class="home-section">
  <div class="text">Receiving Report Archive: View</div>
  ...
  <div class="add-item-container" style="float:left;width:30%">
    <div class="add-item">
      <input type="submit" name="submit" value="Un-Archive" class="add-button" onclick="return confirm('Un-Archive Receiving Report?')">
