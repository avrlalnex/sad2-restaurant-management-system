...
<section class="home-section">
  ...
  <div class="header-container">
    ...
    <a href="purchase_orders_page_archive.php"><button class="add-button">Delivered Orders</button></a>
    <a href="purchase_order_addslip.php"><button class="add-button">Add New Purchase Order</button></a>
  ...
  <div class="inventory-table">
    <table class="item-table">
      ...
      <tbody>
        <?php $inv_tbl->show_purchase_orders($_SESSION['purchase_order_search'],$_SESSION['purchase_order_filter_date']);?>       
      </tbody>
    </table>
