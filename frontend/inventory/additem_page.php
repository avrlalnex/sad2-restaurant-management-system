<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if ($_POST['submit']=="Add"){
      $result = $inv_tbl->add_item($_POST['item-name'],$_POST['item-type'],$_POST['item-unit'],$_POST['item-value']);
...
<section class="home-section">
  ...
  <div class="add-item">
    ...
    <input type="text" id="item-unit" name="item-unit"><br>
    </div>
    <div class="input-container">
    <label for="item-value">Restock Point:</label>
    <input id="input_value" type="text" name="item-value" oninput="check_num(this.value,this.id)"><br>
    </div>
