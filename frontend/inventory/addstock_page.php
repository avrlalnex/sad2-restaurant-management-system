<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if ($_POST['submit']=="Submit"){
      $result = $inv_tbl->add_stockin($_POST['stock-id'],$_POST['stock-quant'],$_POST['stock-expiry']);
      echo $result;
    }
  }
?>
...
<section class="home-section">
  ...
  <div class="add-item">
    ...
    <select id="stock-id" name="stock-id">
      <?php $inv_tbl->show_items();?>   
    </select><br>
    <label for="stock-quant">Quantity:</label>
    <input type="text" id="input_value" oninput="check_num(this.value)" name="stock-quant"><br>
    <label for="expiry">Expiry:</label>
    <input type="date" id="" name="stock-expiry"><br>
