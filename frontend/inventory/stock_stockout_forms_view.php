<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if($_POST['submit'] == 'Archive'){
      $result = $inv_tbl->archive_stockoutform($_SESSION['stockoutFormview_id']);
      header("Location: stock_stockout_forms.php");
      exit();
    }else if($_POST['submit'] == 'Edit'){
      header("Location: stock_stockout_forms_edit.php");
      exit();
    }
  }
?>
...
<section class="home-section">
  ...
  <div class="add-item">
    <input class="add-button" type="submit" name="submit" value="Edit">
    <input class="add-button" type="submit" name="submit" value="Archive">
