  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if($_POST['submit'] == "Set Date"){
      ...
      if($samedateresult == true){
        ...
        $result = $inv_tbl->add_sales_report($_POST['reportTitle'],$_POST['totAmount'],$_POST['repDate']);
...
<div class="sales-entry">
  ...
  <div class="input-container">
    ...
    <input type="text" id="reportTitle" name="reportTitle" value="<?php echo $_SESSION['sales_rep_title']?>">
  </div>
  <div class="input-container">
    <label for="totAmount">Total Amount:</label>
    <input type="number" id="totAmount" name="totAmount" value="<?php echo $inv_tbl->get_sales_report_totalAmt($_SESSION['rep_date']);?>">
  </div>
  <div class="input-container">
