<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if($_POST['submit'] == "Search"){
      ...
      $result = $inv_tbl->unarchive_customer($_POST['customer_id']);   
    }else if($_POST['submit'] == "delete"){
      $result = $inv_tbl->delete_customer($_POST['customer_id']);
    }
  }
?>
<!DOCTYPE html>
...
<section class="home-section">
  ...
  <div class="header-container">
    <a href="sales_customers.php"><button class="add-button">Return</button></a>
  ...
  <table class="item-table">
      ...
      <tbody>
        <?php $inv_tbl->show_sales_customers_archive($_SESSION['customer_search']);?>    
      </tbody>
  <style>
