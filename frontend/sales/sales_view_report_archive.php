<?php
  ...
  $inv_tbl = new sales();
  $result="";
  $_SESSION['rep_date'] = date('Y-m-d');
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if($_POST['submit'] == "Delete"){
      $result = $inv_tbl->delete_report($_SESSION['repView_id']);
      header("Location: sales_reports_archive.php");
      exit();
    }else if($_POST['submit'] == "Un-Archive"){
      $result = $inv_tbl->unarchive_report($_SESSION['repView_id']);
      header("Location: sales_reports_archive.php");
      exit();
    }
  }
...
<section class="home-section">
  ...
  <a href="sales_reports.php"><button class="add-button">Return</button></a>
  </div>
<form method="POST">
  ...
  <div class="input-container">
    ...
    <input type="submit" class="add-button" name="submit" value="Delete" onclick="return confirm('Are you sure?');">
  </div>

  <?php $inv_tbl->show_sales_report_view($_SESSION['repView_id']);?>
...
<div class="sales-table"><div class="inventory-table">
  <table class="item-table">
      ...
      <tbody>
        <?php $inv_tbl->show_sales_report_receipts_view($_SESSION['repView_id']);?>    
      </tbody>
  </table>
  <table class="item-table">
      <thead>
      ...
      <tbody>
        <?php $inv_tbl->show_sales_products_report_view($_SESSION['repView_id']);?>    
      </tbody>
  </table>
</div>
</form>
