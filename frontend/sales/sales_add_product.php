<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if($_POST['submit'] == "Set Date"){
      ...
      $result = $inv_tbl->add_product($_POST['product_type'],$_POST['product_name'],$_POST['product_price']);
...
<section class="home-section">
  <div class="text">Sales - Add Product</div>

<form method="POST">
  <div class="add-item-container">
  <a href="sales_products.php" class="return-icon"><ion-icon name="arrow-back-outline"></ion-icon></a> 
...
<div class="sales-entry">
  ...
  <div class="input-container">
    ...
    <input type="text" id="product_price" name="product_price" value=0 oninput="check_num(this.value,this.id)" required>
  </div>
  <div class="input-container">
