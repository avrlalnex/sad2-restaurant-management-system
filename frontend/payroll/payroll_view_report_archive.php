<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if($_POST['submit'] == "Edit"){
      ...
      $result = $inv_tbl->unarchive_payroll_report($_SESSION['payrep_viewid']);
      header("Location: payroll_reports_archive.php");
      exit();
    }
  }
?>
...
<section class="home-section">
  ...
  <a href="payroll_reports_archive.php"><button class="add-button">Return</button></a>
  </div>
<form method="POST">
