<?php
  ...
  $_SESSION['emp_bonus_select']="";  
  $_SESSION['emp_search'] = "";
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if($_POST['submit'] == "Save Changes"){
      $i=0;
      while($i < $_POST['emp_max']) {
        $result = $inv_tbl->edit_employee_bonus($_POST['emp_id_'.$i],$_POST['emp_bonus_pay_'.$i],$_POST['emp_overtime_hours_'.$i]);
        $i++;
      }
    ...
    }else if($_POST['submit'] == "Add Overtime"){
      $_SESSION['emp_bonus_select'] = $_POST['emp_id_overtime'];
      header("Location: payroll_add_overtime.php");
      exit();
    }
  }
?>
...
<section class="home-section">
  <div class="text">Payroll - Overtime and Bonuses</div>
  ...
  <div class="inventory-table">
    ...
    <tbody>
      <?php $inv_tbl->show_employees_bonuses($_SESSION['emp_search']);?> 
    </tbody>
  </table>
  </form>
