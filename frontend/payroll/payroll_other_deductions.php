...
<section class="home-section">
  <div class="text">Payroll - Deductions and Cash Advances</div>
    <div class="add-profile-button">
    <a href="payroll.php"><button class="add-button">Return</button></a>
    <a href="salary_deduc_rates.php"><button class="add-button">Deduction Rates</button></a>
  ...
  <div class="inventory-table">
    ...
    <thead>
      <tr>
        <th>Name</th>
        <th>Position</th>
        <th>Salary(Salary post rate Deductions)</th>
        <th>Total Amount to Deduct</th>
        <th>Deduction per Salary</th>
      </tr>
    </thead>
    <tbody>
      <?php $inv_tbl->show_employees_otherdeducts($_SESSION['emp_search']);?> 
    </tbody>
  </table>
  </form>
