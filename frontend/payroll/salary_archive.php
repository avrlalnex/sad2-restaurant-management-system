<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if($_POST['submit'] == "Un-Archive"){
      $result = $inv_tbl->unarchive_payroll($_SESSION['id_payrollview']);
      header("Location: payroll_archive.php");
      exit();
    }
  }
?>
...
<section class="home-section">
  <div class="text">Payroll</div>
    ...
    <a href="payroll_archive.php"><button class="add-button">Back</button></a>
    <form method="POST">
