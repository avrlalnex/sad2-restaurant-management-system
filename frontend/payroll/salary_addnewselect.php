<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if($_POST['submit'] == "Select"){
      $_SESSION['empid_addpayroll'] = $_POST['addpayroll_empid'];
      header("Location: salary_addnew.php");
      exit();
...
<section class="home-section">
  <div class="text">Add New Payroll - Employee Select</div>
  ...
  <div class="inventory-table">
    ...
    <tbody>
      <?php $inv_tbl->show_employees_addpayroll($_SESSION['emp_search']);?> 
    </tbody>
  </table>
  <style>
