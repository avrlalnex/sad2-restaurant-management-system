...
<div class="sales-entry">
  ...
  <div class="input-container">
    ...
    <input type="date" id="repfloorDate" name="rep-floorDate" value="<?php echo $_SESSION['rep_floor_dateInput']?>" readonly>
    <label for="repfloorDate">To: </label>
    <input type="date" id="repfloorDate" name="rep-ceilingDate" value="<?php echo $_SESSION['rep_ceiling_dateInput']?>" readonly>
  </div>
  <div class="input-container">
